...
class ListingsRepositoryImplTest {
    ...
    @Test
    fun `getListings returns Success with converted data when API call succeeds`() =
        runTest {
            // Given
    ...
    @Test
    fun `getListings returns ServerError with HTTP code in message when HttpException occurs`() =
        runTest {
            // Given
            val httpException =
                HttpException(
    ...
    @Test
    fun `getListings returns NetworkUnavailable with exception message when IOException occurs`() =
        runTest {
            // Given
    ...
    @Test
    fun `getListings returns UnknownError with exception type and message when generic exception occurs`() =
        runTest {
            // Given
