...
class GetListingDetailsUseCaseTest {
    ...
    @Test
    fun `invoke returns ServerError when repository returns ServerError`() = runTest {
        // Given
        val listingId = 1
    ...
    @Test
    fun `invoke returns NetworkUnavailable when repository returns NetworkUnavailable`() = runTest {
        // Given
        val listingId = 1
    ...
    @Test
    fun `invoke returns UnknownError when repository returns UnknownError`() = runTest {
        // Given
        val listingId = 1
