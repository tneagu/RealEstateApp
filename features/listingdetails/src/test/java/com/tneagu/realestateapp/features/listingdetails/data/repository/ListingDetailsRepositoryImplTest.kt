...
class ListingDetailsRepositoryImplTest {
    ...
    @Test
    fun `getListingDetails returns Success with converted data when API call succeeds`() = runTest {
        // Given
        val listingId = 1
        val responseDto = mockk<ListingDetailDto>()
        val expectedDetail = ListingDetail(
            id = 1,
            bedrooms = 3,
            city = "Paris",
            area = 120.5,
    ...
    @Test
    fun `getListingDetails returns ServerError with HTTP code in message when HttpException occurs`() = runTest {
        // Given
        val listingId = 1
    ...
    @Test
    fun `getListingDetails returns NetworkUnavailable with exception message when IOException occurs`() = runTest {
        // Given
        val listingId = 1
    ...
    @Test
    fun `getListingDetails returns UnknownError with exception type and message when generic exception occurs`() = runTest {
        // Given
        val listingId = 1
